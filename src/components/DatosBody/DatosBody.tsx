...
import { LoadingSpinner, DatosSelect, CustomDatePicker } from '../';
import { useLoading } from '../../context/LoadingContext';
import { useDatosBody } from '../../hooks';

import './DatosBody.css';
    ...
    <>
        {
            ...
            (
                <div className="w-100">
                    ...
                    {/* <div className="mt-2 datos-box">
                        {currentDato.map((dato)=>(
                            <>
                                {dato} <br/>
                            </>
                        ))}
