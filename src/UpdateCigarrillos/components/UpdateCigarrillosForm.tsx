import { CigarrillosToUpdateTable } from './CigarrillosToUpdateTable';
import { useAppStore } from '../../common/hooks/useAppStore';
import { useUpdateCigarrillosForm } from '../hooks/useUpdateCigarrillosForm';
import { CustomCigarrillosSelect } from '../../common/components';

export const UpdateCigarrillosForm = () => {
